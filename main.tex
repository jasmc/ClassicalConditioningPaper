...
\begin{figure}
  \begin{fullwidth}
    ...
    \caption{
      ...
      % (A) Population-level learning. Heatmaps of scaled vigour across trials for (left), 3sTrace (middle), and 10sTrace (right) groups. Data are binned in \SI{0.5}{\second} intervals. Rows represent individual trials (pre-training at top, test at bottom).
      ...
      % (D) Temporal dynamics. Median $\pm$ confidence interval of scaled vigour (\SI{1}{\second} bins), illustrating CR timing and extinction. Green bars mark CS onset and offset.
      % Number of fish tested:, n=34 (test), n=36 (control); 3sTrace, n=79 (test), n=83 (control); 10sTrace, n=22 (test), n=18 (control).
    }
    \label{fig:fig2}
  \end{fullwidth}
\end{figure}
